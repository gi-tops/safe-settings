        ...
        this.branches
          ...
          .map(async (branch) => {
            ...
            if (this.isEmpty(branch.protection)) {
              ...
              try {
                await this.github.rest.repos.listBranches({
                  accept: 'application/vnd.github.v3+json',
                  owner: this.repo.owner,
                  repo: this.repo.repo
                })
                  //.catch(e => {this.log.error(`Error returning branches - ${this.repo.owner} - ${this.repo.repo} - ${JSON.stringify(e)}`)})
                const new_readme = `
# ${this.repo.repo}
...
`
                ...
                this.log.error(`creating branch ${JSON.stringify(e)}`)
              }
...
`
                ...
                // return this.log(`Branch protection applied successfully`)
